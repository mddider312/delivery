                            ...
                            <div class="card-body">
                                ...
                                <div id="upcoming-task" class="pb-1 task-list">
                                    <div class="card task-box">
                                        <div class="card-body">
                                            <div class="float-end ms-2">
                                                <span
                                                    class="badge rounded-pill badge-soft-secondary font-size-12">Waiting</span>
                                            </div>
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                                        class="text-dark">Topnav layout design</a></h5>
                                    ...
                                    <div class="card task-box">
                                        <div class="card-body">
                                            <div class="float-end ms-2">
                                                <span
                                                    class="badge rounded-pill badge-soft-primary font-size-12">Approved</span>
                                            </div>
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                                        class="text-dark">Create a New Landing UI</a></h5>
                                    ...
                                    <div class="card task-box">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                                        class="text-dark">Create a Qovex Logo</a></h5>
                                ...
                                <div class="text-center">
                                    <a href="javascript: void(0);"
                                        class="btn btn-primary w-100 waves-effect waves-light"><i
                                ...
                                <div id="inprogress-task" class="pb-1 task-list">
                                    <div class="card task-box">
                                        <div class="card-body">
                                            <div class="float-end ms-2">
                                                <span
                                                    class="badge rounded-pill badge-soft-success font-size-12">Complete</span>
                                            </div>
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                    ...
                                    <div class="card task-box">
                                        <div class="card-body">
                                            <div class="float-end ms-2">
                                                <span
                                                    class="badge rounded-pill badge-soft-warning font-size-12">Pending</span>
                                            </div>
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                    ...
                                    <div class="card task-box">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                                        class="text-dark">Qovex Dashboard UI</a></h5>
                                                <p class="text-muted mb-4">13 Oct, 2019</p>
                                            </div>
                                ...
                                <div id="complete-task" class="pb-1 task-list">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-inline mb-4">
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <div>
                                                            <img src="assets/images/small/img-1.jpg" class="rounded"
                                                                alt="" height="48">
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <div>
                                                            <img src="assets/images/small/img-2.jpg" class="rounded"
                                                                alt="" height="48">
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);">
                                                        <div>
                                                            <img src="assets/images/small/img-3.jpg" class="rounded"
                                                                alt="" height="48">
                                                        </div>
                                                    </a>
                                                </li>
                                    ...
                                    <div class="card task-box">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <h5 class="font-size-15"><a href="javascript: void(0);"
                                                        class="text-dark">Qovex landing Psd</a></h5>
                                                <p class="text-muted mb-4">15 Oct, 2019</p>
                                            </div>
