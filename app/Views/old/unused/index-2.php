                                ...
                                <ul class="list-unstyled activity-wid">
                                    <li class="activity-list">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="me-3">
                                                <h5 class="font-size-14">20 Jan <i class="mdi mdi-arrow-right text-primary align-middle ms-2"></i>
                                                </h5>
                                            </div>
                                            <div class="flex-1">
                                                <div>
                                    ...
                                    <li class="activity-list">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="me-3">
                                                <h5 class="font-size-14">23 Jan <i class="mdi mdi-arrow-right text-primary align-middle ms-2"></i>
                                                </h5>
                                            </div>
                                            <div class="flex-1">
                                                <div>
                                    ...
                                    <li class="activity-list">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="me-3">
                                                <h5 class="font-size-14">24 Jan <i class="mdi mdi-arrow-right text-primary align-middle ms-2"></i>
                                                </h5>
                                            </div>
                                            <div class="flex-1 d-flex">
                                                <div>
                                                    Everyone realizes why a new common language.. <a href="javascript: void(0);">Read
                                                        more</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="activity-list">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="me-3">
                                                <h5 class="font-size-14">26 Jan <i class="mdi mdi-arrow-right text-primary align-middle ms-2"></i>
                                                </h5>
                                            </div>
                                            <div class="flex-1">
                                                <div>
