                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc">Any single <code class="highlighter-rouge">.btn</code>
                                        ...
                                        can put them to work with either <code
                                            class="highlighter-rouge">&lt;button&gt;</code> elements:
                                    </p>
                                    ...
                                    <div >
                                        <div class="btn-group me-1 mt-2">
                                            <button type="button" class="btn btn-primary dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Primary
