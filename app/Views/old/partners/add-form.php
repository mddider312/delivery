            ...
            <div class="page-content">
                ...
                <div class="row align-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4"><?= lang('Files.Add_New_Partner') ?></h4>

                                <form action="<?= base_url('save_partner');?>" method="POST">
                                <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <input class="form-control" type="text" name="adddress" placeholder="">
                                            </div>
                                            <div class="col-lg-12 mb-3">
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <input class="form-control" type="text" name="pic_name" placeholder="">
                                            </div>
                                            <div class="col-lg-12 mb-3">
                                                <label class="form-label">PIC Contact.</label>
                                                <input class="form-control" type="text" name="pic_phone" placeholder="">
                                            </div>
                                        </div>
                                    </div>
