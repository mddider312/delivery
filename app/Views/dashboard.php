                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-4"><?=  $today_sales['total'] ?? 0.00; ?></h4>
                                <div class="row">
                                    <div class="col-7">
                                        <p class="mb-0">
                                            <?php 
                                                $today_sales['increments'] = 0;
                                            if($today_sales['increments'] > 0){ ?>
                                                <span class="text-success me-2"> <?=  $today_sales['increments'] ?? 0.00; ?>% <i class="mdi mdi-arrow-up"></i> </span>
                                            <?php }else{ ?>
                                                <span class="text-danger me-2"> <?=  $today_sales['increments'] ?? 0.00; ?>% <i class="mdi mdi-arrow-down"></i> </span>
                                            <?php } ?>
                                        </p>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-size-16 mt-2">Total Shipments</div>

                                    </div>
                                </div>
                                <h4 class="mt-4"><?=  $total_partners ?? 0; ?></h4>
                                <div class="row">
                                    <div class="col-7">
...
<script>
    ...
    series: [
        {
            name: "<?=  $sales_report['last_year']['year'] ?? 2023; ?>",
            type: 'line',
            data: [
                <?=  $sales_report['last_year']['dataset'][0] ?? 0; ?>,
                <?=  $sales_report['last_year']['dataset'][1] ?? 0; ?>,
                <?=  $sales_report['last_year']['dataset'][2] ?? 0; ?>,
                <?=  $sales_report['last_year']['dataset'][3] ?? 0; ?>,
                <?=  $sales_report['last_year']['dataset'][4] ?? 0; ?>,
                <?=  $sales_report['last_year']['dataset'][5] ?? 0; ?>,
                <?=  $sales_report['last_year']['dataset'][6] ?? 0; ?>,
            ],
        },
        {
            name: "<?=  $sales_report['current_year']['year'] ?? 0; ?>",
            data: [
                <?=  $sales_report['current_year']['dataset'][0] ?? 0; ?>,
                <?=  $sales_report['current_year']['dataset'][1] ?? 0; ?>,
                <?=  $sales_report['current_year']['dataset'][2] ?? 0; ?>,
                <?=  $sales_report['current_year']['dataset'][3] ?? 0; ?>,
                <?=  $sales_report['current_year']['dataset'][4] ?? 0; ?>,
                <?=  $sales_report['current_year']['dataset'][5] ?? 0; ?>,
                <?=  $sales_report['current_year']['dataset'][6] ?? 0; ?>,
            ],
            type: 'area',
        }
    ],
    ...
    xaxis: {
        categories: [
            "<?=  $sales_report['label'][0] ?? 0; ?>", 
            "<?=  $sales_report['label'][1] ?? 0; ?>", 
            "<?=  $sales_report['label'][2] ?? 0; ?>", 
            "<?=  $sales_report['label'][3] ?? 0; ?>", 
            "<?=  $sales_report['label'][4] ?? 0; ?>", 
            "<?=  $sales_report['label'][5] ?? 0; ?>", 
            "<?=  $sales_report['label'][6] ?? 0; ?>", 
